...
- Localization lives in grouped JSON resources under `src/AgentContext.Application/locales/{locale}/*.json` (ADR 0008) — embedded by the backend and imported by the Vite frontend (needs `server.fs.allow: ['..']`).

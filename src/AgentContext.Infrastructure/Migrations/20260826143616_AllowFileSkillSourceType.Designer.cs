...
namespace AgentContext.Infrastructure.Migrations
{
    ...
    [Migration("20260826143616_AllowFileSkillSourceType")]
    partial class AllowFileSkillSourceType
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("AgentContext.Domain.Entities.Skill", b =>
                {
                    ...
                    b.ToTable("skills", null, t =>
                        {
                            t.HasCheckConstraint("ck_skills_source_type", "source_type IS NULL OR source_type IN ('manual', 'file', 'zip', 'skills_sh', 'local_copy')");
